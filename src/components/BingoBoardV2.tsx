            ...
            {isBlackoutMode ? (
              <div className="bg-zinc-950 px-6 py-4 rounded shadow-2xl border-2 border-green-500">
                ...
                <div className="flex gap-2">
                  <Button onClick={() => setShowWinPopup(false)} variant="outline" className="flex-1 h-9 text-[#17BB34] hover:bg-[#17BB34] hover:text-zinc-900" style={{ borderColor: GREEN, fontSize: '13px' }}>Stay here</Button>
                  <Button onClick={handleEndGame} variant="outline" className="flex-1 h-9 text-[#17BB34] hover:bg-[#17BB34] hover:text-zinc-900" style={{ borderColor: GREEN, fontSize: '13px' }}>Go to Lobby</Button>
                </div>
              </div>
            ) : (
